...
tiff("Figs/Fig_Cedar_decomposition.tif", width=10, height=8, 
...
tiff("Figs/Fig_Cedar_shannon.tif", width=10, height=12, 
     units="in", res=300, compression = "lzw")
...
tiff("Figs/Fig_Cedar_inv.simpson.tif", width=10, height=12, 
     units="in", res=300, compression = "lzw")
